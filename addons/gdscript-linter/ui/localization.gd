...
static var _text := {
	LANGUAGE_EN: {
		...
		"scan_path": "Scan Path:",
		"scan_path_placeholder": "res:// or res://addons/my_addon",
		"scan_path_tooltip": "File or directory to analyze. Use res://addons/my_addon to scan one addon only.",
	...
	LANGUAGE_RU: {
		...
		"scan_path": "Путь анализа:",
		"scan_path_placeholder": "res:// или res://addons/my_addon",
		"scan_path_tooltip": "Файл или папка для анализа. Укажи res://addons/my_addon, чтобы проверить только один аддон.",
